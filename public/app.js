...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UIFilterBar = __webpack_require__(159);

	var _UIFilterBar2 = _interopRequireDefault(_UIFilterBar);
	...
	var props = {
	  ...
	  lockOnChange: false,
	  callback: function callback(filters, obj) {
	    var html = '<ul>';
	...
	_reactDom2.default.render(_react2.default.createElement(_UIFilterBar2.default, props), document.getElementById('root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UIFilterDropdown = __webpack_require__(161);

	var _UIFilterDropdown2 = _interopRequireDefault(_UIFilterDropdown);

	var _UIFilterDropdownAsync = __webpack_require__(162);

	var _UIFilterDropdownAsync2 = _interopRequireDefault(_UIFilterDropdownAsync);

	var _UISearch = __webpack_require__(164);
	...
	var UIFilterBar = function (_Component) {
	  _inherits(UIFilterBar, _Component);

	  function UIFilterBar(props) {
	    _classCallCheck(this, UIFilterBar);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(UIFilterBar).call(this, props));

	    var _u$getUrlParams = _utils2.default.getUrlParams(window.location.href);

	    var params = _u$getUrlParams.params;


	    _this.values = {};
	    _this.prevValue = null;
	    _this.filters = _this.mergeFiltersWithParams(params, _this.values);
	    return _this;
	  }

	  _createClass(UIFilterBar, [{
	    key: 'mergeFiltersWithParams',
	    value: function mergeFiltersWithParams(params, values) {
	      var arr = [];
	      var filters = _utils2.default.cloneObject(this.props.filters);
	      ...
	      for (var i = 0, l = filters.length; i < l; i++) {
	        ...
	        if (filter.opts) {
	          selected = filter.opts.reduce(function (str, opt) {
	    ...
	    value: function filterChangeHandler(name, value, filter) {
	      var _this2 = this;

	      var prevs = this.getValues();
	      var unlock = void 0;
	      this.prevValue = {
	        name: name,
	        filter: filter,
	      ...
	      if (this.props.callback) {
	        if (this.props.lockOnChange) {
	          ...
	          unlock = function unlock(err) {
	            if (err) _this2.cancelChange();
	            _this2.lockFilters(false);
	          };
	        }
	        this.props.callback(this.getValues(), { name: name, value: value }, unlock);
	      }
	    }
	  }, {
	    key: 'cancelChange',
	    value: function cancelChange() {
	      var _prevValue = this.prevValue;
	      var name = _prevValue.name;
	      var filter = _prevValue.filter;
	      var value = _prevValue.value;
	    ...
	    key: 'lockFilters',
	    value: function lockFilters(lock) {
	      var btns = this.refs['list'].querySelectorAll('button, input[type="text"]');
	    ...
	    value: function renderFilters() {
	      ...
	      return this.filters.map(function (filter) {
	        filter.callback = function (name, value, filter) {
	          _this3.filterChangeHandler(name, value, filter);
	        };
	        var component = void 0;
	        switch (filter.filterType) {
	          case 'UIFilterDropdown':
	            component = _react2.default.createElement(_UIFilterDropdown2.default, filter);
	            break;
	          case 'UIFilterDropdownAsync':
	            component = _react2.default.createElement(_UIFilterDropdownAsync2.default, filter);
	            break;
	          case 'UISearch':
	            component = _react2.default.createElement(_UISearch2.default, filter);
	            break;
	        }
	        return _react2.default.createElement(
	          'li',
	          { key: 'filter-' + filter.name, className: 'filter-list-item filter-' + filter.filterType.toLowerCase() },
	          component
	        );
	      });
	    }
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'ul',
	        { className: 'filter-list', ref: 'list' },
	        this.renderFilters()
	      );
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var u = {
	  ...
	  cloneObject: function cloneObject(obj) {
	    var copy = void 0;
	    if (null === obj || undefined === obj || 'object' !== (typeof obj === 'undefined' ? 'undefined' : _typeof(obj))) return obj;
	  ...
	  getUrlParams: function getUrlParams(str) {
	    var arr = str.split('?');
	    var decoded = {};
	    var params = {};
	    var tmp = void 0,
	  ...
	  mapStringWithObjectValues: function mapStringWithObjectValues(str, obj) {
	    var reg = /\{.*?\}/g;
	    return str.replace(reg, function (key) {
	      key = key.replace(/\{|\}/g, '');
	      return key.split('.').reduce(function (o, n) {
	        return (typeof o === 'undefined' ? 'undefined' : _typeof(o)) === 'object' ? o[n] : undefined;
	      }, obj);
	    });
	  },
	  checkValidity: function checkValidity(form) {
	    var a = form.querySelectorAll('*[name]');
	    var btn = void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UIFilterDropdown = function (_Component) {
	  _inherits(UIFilterDropdown, _Component);

	  function UIFilterDropdown(props) {
	    _classCallCheck(this, UIFilterDropdown);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(UIFilterDropdown).call(this, props));

	    var opts = _this.props.opts || [];
	    var selected = _this.getSelected(opts);
	    _this.usePrompt = _this.props.usePrompt !== undefined ? _this.props.usePrompt : true;
	    _this.state = { opts: opts, selected: selected };
	    return _this;
	  }

	  _createClass(UIFilterDropdown, [{
	    key: 'updateState',
	    value: function updateState(notify) {
	      var selected = this.getSelected(this.state.opts);
	      this.setState({ opts: this.state.opts, selected: selected });

	      if (notify && this.props.callback) this.props.callback(this.props.name, this.getValues(this.state.opts), this);
	    }
	  }, {
	    key: 'getValues',
	    value: function getValues(opts) {
	      var selected = opts.reduce(function (str, opt) {
	        return opt.checked ? str + (',' + opt.value) : str;
	      }, '');
	    ...
	    key: 'getSelected',
	    value: function getSelected(opts) {
	      var selected = opts.reduce(function (str, opt) {
	    ...
	    value: function setSelected(value) {
	      var opt = this.state.opts.find(function (opt) {
	    ...
	    key: 'changeHandler',
	    value: function changeHandler(opt) {
	    ...
	    key: 'resetOptsHandler',
	    value: function resetOptsHandler() {
	    ...
	    value: function renderButton() {
	      var dropType = this.props.dropup ? 'mdi mdi-chevron-up' : 'mdi mdi-chevron-down';
	      var button = void 0;

	      if (this.props.useIcon) {
	        button = _react2.default.createElement(
	          'button',
	          { className: 'btn btn-default btn-sm', type: 'button', 'data-toggle': 'dropdown', 'aria-haspopup': 'true', 'aria-expanded': 'false' },
	          _react2.default.createElement('i', { className: this.props.useIcon }),
	          ' ',
	          _react2.default.createElement('i', { className: dropType })
	        );
	      } else {
	        button = _react2.default.createElement(
	          'button',
	    ...
	    value: function renderList() {
	      ...
	      return this.state.opts.map(function (opt) {
	        var checked = opt.checked ? _react2.default.createElement(
	          'span',
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', {
	              ...
	              type: _this2.props.multiple ? 'checkbox' : 'radio',
	              checked: opt.checked,
	              value: opt.value,
	              onChange: function onChange(e) {
	                e.preventDefault();
	                _this2.changeHandler(opt);
	              }
	            })
	          )
	        );
	    ...
	    value: function renderPrompt() {
	      ...
	      if (this.usePrompt) {
	        render = _react2.default.createElement(
	          'li',
	          { key: 'all', onClick: function onClick(e) {
	              return _this3.resetOptsHandler();
	            } },
	          _react2.default.createElement(
	            'label',
	            null,
	            window.I18n.t('admin.commons.all')
	          )
	        );
	      }
	      return render;
	    ...
	    key: 'render',
	    value: function render() {
	      var dropType = this.props.dropup ? 'dropdown dropup' : 'dropdown';
	      return _react2.default.createElement(
	        'div',
	        { className: dropType },
	        this.renderButton(),
	        _react2.default.createElement(
	          'ul',
	          { className: 'dropdown-menu', 'aria-labelledby': 'dLabel' },
	          this.renderPrompt(),
	          this.renderList()
	        )
	      );
	  ...
	  return UIFilterDropdown;
	}(_react.Component);

	exports.default = UIFilterDropdown;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Fetch = __webpack_require__(163);
	...
	var UIFilterDropdownAsync = function (_Component) {
	  _inherits(UIFilterDropdownAsync, _Component);

	  function UIFilterDropdownAsync(props) {
	    _classCallCheck(this, UIFilterDropdownAsync);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(UIFilterDropdownAsync).call(this, props));

	    _this.state = { data: [], loading: true, error: false };
	    return _this;
	  }

	  _createClass(UIFilterDropdownAsync, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      _Fetch2.default.get(this.props.url).then(function (data) {
	        mapped = data[_this2.props.data].map(function (item) {
	          reg = new RegExp(',' + item[_this2.props.map.value] + ',');
	          return {
	            label: item[_this2.props.map.label],
	            value: item[_this2.props.map.value],
	    ...
	    value: function render() {
	      ...
	      if (this.state.error) {
	        render = _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { className: 'btn btn-default btn-sm', disabled: true },
	            _react2.default.createElement('i', { className: 'mdi mdi-close' }),
	            ' ',
	            '' + window.I18n.t('admin.commons.error')
	          )
	        );
	      } else {
	        if (this.state.loading) {
	          render = _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'button',
	              { className: 'btn btn-default btn-sm', disabled: true },
	              _react2.default.createElement('i', { className: 'mdi mdi-refresh mdi-spin' }),
	              ' ',
	              window.I18n.t('admin.commons.loading') + '...'
	            )
	          );
	        } else {
	          props = _utils2.default.cloneObject(this.props);
	          props.opts = props.opts ? props.opts.concat(this.state.data) : this.state.data;

	          render = _react2.default.createElement(_UIFilterDropdown2.default, props);
	        }
	      }
	  ...
	  return UIFilterDropdownAsync;
	}(_react.Component);

	exports.default = UIFilterDropdownAsync;
...
/***/ function(module, exports) {
	...
	var FakeData = {
	  tags: [{ id: '1', text: 'Tag001' }, { id: '2', text: 'Tag002' }, { id: '3', text: 'Tag003' }, { id: '4', text: 'Tag004' }, { id: '5', text: 'Tag005' }]
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UISearch = function (_React$Component) {
	  _inherits(UISearch, _React$Component);

	  function UISearch(props) {
	    _classCallCheck(this, UISearch);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(UISearch).call(this, props));

	    _this.timer = null;
	    _this.last = null;
	    _this.delay = 300;

	    _this.name = _this.props.name || 'query';
	    _this.placeholder = _this.props.placeholder || '';
	    _this.callback = _this.props.callback || function (q) {
	      console.log(q);
	    };
	  ...
	  _createClass(UISearch, [{
	    ...
	    value: function renderClearButton() {
	      ...
	      if (this.state.value) {
	        return _react2.default.createElement(
	          'span',
	          { className: 'ui-search-remove', onClick: function onClick() {
	              return _this3.changeHandler('');
	            } },
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: this.state.value ? 'search-box clear-btn' : 'search-box' },
	        _react2.default.createElement('input', {
	          type: 'text',
	          ...
	          onChange: function onChange(e) {
	            return _this4.changeHandler(e.target.value);
	          }
	        }),
